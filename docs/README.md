...
Detailed guides and API reference for `@ijonis/geo-lint`.
...
| [api.md](api.md) | Programmatic API reference -- `lint()`, `lintQuiet()`, and `LintResult` |
| [agent-integration.md](agent-integration.md) | Agent integration guide for Claude Code, Cursor, Windsurf, and other AI agents |

---

For installation, quick start, and project overview, see the [main README](../README.md).
